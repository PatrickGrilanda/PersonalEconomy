<div class="flex justify-center w-full h-full">
    <div class="lg:w-[75rem] bg-white rounded-2xl shadow my-4 p-4">
        <div class="flex justify-between my-2">
                ...
                <template x-if="open">
                    <div class="rounded-lg shadow absolute z-10 min-w-64 min-h-44 top-0 start-full p-4 bg-white">
                        ...
                        <div class="w-full p-2">
                            ...
                            <select class="form-input w-full" wire:model.live="category_id"
            ...
            <div class="w-80">
                <div class="inline-flex items-center gap-4 w-full" x-show="$wire.selectedTransactionIds.length > 0"
                    x-cloak>
                    <div>
        ...
        @if ($category_id || $type)
            <div x-data class="rounded-full bg-orange-500 gap-4 w-full p-2 h-12 inline-flex items-center">
                ...
                @if ($type)
                    <div
                        class="rounded-full h-8 text-sm bg-white text-orange-700 py-2 px-4 inline-flex items-center gap-2">
                ...
                @if ($transactions->count() > 0)
                    @foreach ($transactions as $transaction)
                        <tr wire:key="{{ $transaction->id }}"
                            ...
                            <td class="whitespace-nowrap p-3 text-sm text-end font-semibold">
